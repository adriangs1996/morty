...
module Dry::Schema
  class << self
    # source://dry-schema/1.14.0/lib/dry/schema.rb#86
    def Form(**options, &_arg1); end

    # source://dry-schema/1.14.0/lib/dry/schema.rb#106
    def JSON(**options, &_arg1); end

    # source://dry-schema/1.14.0/lib/dry/schema.rb#86
    def Params(**options, &_arg1); end

    # source://dry-schema/1.14.0/lib/dry/schema.rb#48
    def config; end

    # source://dry-schema/1.14.0/lib/dry/schema.rb#67
    def define(*_arg0, **_arg1, &_arg2); end

    # source://dry-schema/1.14.0/lib/dry/schema.rb#18
    def loader; end
  end
end
...
class Dry::Schema::Path
  # source://dry-schema/1.14.0/lib/dry/schema/path.rb#57
  def initialize(keys); end

  # source://dry-schema/1.14.0/lib/dry/schema/path.rb#88
  def &(other); end

  # source://dry-schema/1.14.0/lib/dry/schema/path.rb#79
  def <=>(other); end

  # source://dry-schema/1.14.0/lib/dry/schema/path.rb#69
  def each(&_arg0); end
  ...
  # source://dry-schema/1.14.0/lib/dry/schema/path.rb#74
  def include?(other); end

  # source://dry-schema/1.14.0/lib/dry/schema/path.rb#16
  def keys; end

  # source://dry-schema/1.14.0/lib/dry/schema/path.rb#95
  def last; end
  ...
  # source://dry-schema/1.14.0/lib/dry/schema/path.rb#100
  def same_root?(other); end

  # source://dry-schema/1.14.0/lib/dry/schema/path.rb#62
  def to_h(value = T.unsafe(nil)); end

  class << self
    # source://dry-schema/1.14.0/lib/dry/schema/path.rb#43
    def [](spec); end

    # source://dry-schema/1.14.0/lib/dry/schema/path.rb#27
    def call(spec); end

    # source://dry-schema/1.14.0/lib/dry/schema/path.rb#50
