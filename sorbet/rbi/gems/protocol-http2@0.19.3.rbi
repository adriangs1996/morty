...
class Protocol::HTTP2::Connection
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#353
  ...
  # @return [Boolean]
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#423
  ...
  # @return [Boolean]
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#450
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#360
  ...
  # source://protocol-http2//lib/protocol/http2/connection.rb#279
  def open!; end
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#256
  ...
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#377
  def receive_headers(frame); end

  # source://protocol-http2//lib/protocol/http2/connection.rb#307
  def receive_ping(frame); end

  # Sets the priority for an incoming stream.
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#411
  def receive_priority(frame); end

  # @raise [ProtocolError]
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#419
  def receive_push_promise(frame); end

  # source://protocol-http2//lib/protocol/http2/connection.rb#459
  def receive_reset_stream(frame); end

  # source://protocol-http2//lib/protocol/http2/connection.rb#285
  ...
  # source://protocol-http2//lib/protocol/http2/connection.rb#296
  def send_ping(data); end

  # source://protocol-http2//lib/protocol/http2/connection.rb#403
  ...
  # @return [Boolean]
  #
  # source://protocol-http2//lib/protocol/http2/connection.rb#427
  ...
  # source://protocol-http2//lib/protocol/http2/connection.rb#235
  def update_local_settings(changes); end

  # source://protocol-http2//lib/protocol/http2/connection.rb#245
  ...
  # source://protocol-http2//lib/protocol/http2/connection.rb#223
...
#
# source://protocol-http2//lib/protocol/http2/stream.rb#61
class Protocol::HTTP2::Stream
  include ::Protocol::HTTP2::FlowControlled

  # @return [Stream] a new instance of Stream
  #
  # source://protocol-http2//lib/protocol/http2/stream.rb#72
  def initialize(connection, id, state = T.unsafe(nil)); end

  # Override this function to implement your own push promise logic.
  #
  # source://protocol-http2//lib/protocol/http2/stream.rb#421
  def accept_push_promise_stream(stream_id, headers); end

  # @return [Boolean]
  #
  # source://protocol-http2//lib/protocol/http2/stream.rb#122
  def active?; end
  ...
  #
  # source://protocol-http2//lib/protocol/http2/stream.rb#235
  ...
  # source://protocol-http2//lib/protocol/http2/stream.rb#189
  def consume_remote_window(frame); end

  # Override this function to implement your own push promise logic.
  #
  # source://protocol-http2//lib/protocol/http2/stream.rb#399
  ...
  # Stream ID (odd for client initiated streams, even otherwise).
  #
  # source://protocol-http2//lib/protocol/http2/stream.rb#88
  def id; end

  # source://protocol-http2//lib/protocol/http2/stream.rb#318
  def ignore_data(frame); end

  # source://protocol-http2//lib/protocol/http2/stream.rb#436
  def inspect; end
  ...
  #
  # source://protocol-http2//lib/protocol/http2/stream.rb#314
  def process_data(frame); end

  # source://protocol-http2//lib/protocol/http2/stream.rb#266
  ...
  #
  # source://protocol-http2//lib/protocol/http2/stream.rb#323
  def receive_data(frame); end
  ...
  # source://protocol-http2//lib/protocol/http2/stream.rb#348
  def receive_reset_stream(frame); end
  ...
  # source://protocol-http2//lib/protocol/http2/stream.rb#378
  def reserved_local!; end

  # source://protocol-http2//lib/protocol/http2/stream.rb#388
  def reserved_remote!; end

  # source://protocol-http2//lib/protocol/http2/stream.rb#206
  ...
  # source://protocol-http2//lib/protocol/http2/stream.rb#118
  def write_frame(frame); end

  protected

  # source://protocol-http2//lib/protocol/http2/stream.rb#277
  def ignore_headers(frame); end

  private

  # source://protocol-http2//lib/protocol/http2/stream.rb#195
  ...
  #
  # source://protocol-http2//lib/protocol/http2/stream.rb#364
  def write_push_promise(stream_id, headers, flags = T.unsafe(nil), **options); end

  class << self
    # source://protocol-http2//lib/protocol/http2/stream.rb#64
