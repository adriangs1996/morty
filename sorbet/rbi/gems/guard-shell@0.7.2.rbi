...
module Guard
  ...
  class << self
    # source://guard/2.19.0/lib/guard.rb#87
    def async_queue_add(changes); end

    # source://guard/2.19.0/lib/guard.rb#73
    def init(cmdline_options); end

    # source://guard/2.19.0/lib/guard.rb#24
    def interactor; end

    # source://guard/2.19.0/lib/guard.rb#23
    def listener; end

    # source://guard/2.19.0/lib/guard.rb#22
    def queue; end

    # source://guard/2.19.0/lib/guard.rb#44
    def setup(cmdline_options = T.unsafe(nil)); end

    # source://guard/2.19.0/lib/guard.rb#21
    def state; end

    private

    # source://guard/2.19.0/lib/guard.rb#132
    def _evaluate(options); end

    # source://guard/2.19.0/lib/guard.rb#152
    def _guardfile_deprecated_check(modified); end

    # source://guard/2.19.0/lib/guard.rb#113
    def _listener_callback; end

    # source://guard/2.19.0/lib/guard.rb#128
    def _pluginless_guardfile?; end

    # source://guard/2.19.0/lib/guard.rb#109
    def _relative_pathnames(paths); end

    # source://guard/2.19.0/lib/guard.rb#99
...
class Guard::Dsl
  # source://guard/2.19.0/lib/guard/dsl.rb#246
  def callback(*args, &block); end

  # source://guard/2.19.0/lib/guard/dsl.rb#408
  def clearing(on); end

  # source://guard/2.19.0/lib/guard/dsl.rb#394
  ...
  # source://guard/2.19.0/lib/guard/dsl.rb#377
  def evaluate(contents, filename, lineno); end

  # source://guard/2.19.0/lib/guard/dsl.rb#267
  def filter(*regexps); end

  # source://guard/2.19.0/lib/guard/dsl.rb#282
  def filter!(*regexps); end

  # source://guard/2.19.0/lib/guard/dsl.rb#124
  def group(*args); end

  # source://guard/2.19.0/lib/guard/dsl.rb#176
  ...
  # source://guard/2.19.0/lib/guard/dsl.rb#91
  def interactor(options); end

  # source://guard/2.19.0/lib/guard/dsl.rb#325
  ...
  # source://guard/2.19.0/lib/guard/dsl.rb#76
  def notification(notifier, opts = T.unsafe(nil)); end

  # source://guard/2.19.0/lib/guard/dsl.rb#372
  def scope(scope = T.unsafe(nil)); end

  # source://guard/2.19.0/lib/guard/dsl.rb#218
  def watch(pattern, &action); end

  private

  # source://guard/2.19.0/lib/guard/dsl.rb#414
