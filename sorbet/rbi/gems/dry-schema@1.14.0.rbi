...
# @api private
#
# source://dry-schema//lib/dry/schema/extensions/json_schema/schema_compiler.rb#12
...
class Dry::Schema::Macros::DSL < ::Dry::Schema::Macros::Core
  ...
  def filled(*args, **opts, &_arg2); end
...
class Dry::Schema::Macros::Filled < ::Dry::Schema::Macros::Value
  ...
  def call(*predicates, **opts, &_arg2); end
...
class Dry::Schema::Path
  ...
  # source://dry-validation/1.11.1/lib/dry/validation/schema_ext.rb#14
  def expand; end
  ...
  # source://dry-validation/1.11.1/lib/dry/validation/schema_ext.rb#9
  def multi_value?; end
